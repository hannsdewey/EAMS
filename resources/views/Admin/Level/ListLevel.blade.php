                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body px-0">
                         <h5 class="card-title float-left mb-2 tx">List of Qualifications</h5>
                         <div class="float-right"> 
                          <form method="get">    
                            <div class="form-group mb-3" style="display: flex"> 
                              <a href="{{url('admin/level-management/add')}}">
                                <div class="btn btn-success mr-2" style="width: 120px;">Add Qualifications</div>      
                              </a>                
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-striped">
                            <thead>
                              ...
                              <th width="15%">Amount of people</th>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Delete Qualifications</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">
                                 <p>Bạn Agree Delete Qualifications {{$item->qualification_name}}?</p>
                               </div>
                               <div class="p-2">
