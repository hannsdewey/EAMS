                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body px-0">
                         <h5 class="card-title float-left mb-2 tx">List Position</h5>
                         <div class="float-right"> 
                          <form method="get">    
                            <div class="form-group mb-3" style="display: flex"> 
                              <a href="{{url('admin/position-management/add')}}">
                                <div class="btn btn-success mr-2" style="width: 120px;">Add position</div>      
                              </a>                
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                 <p>Bạn Agree Delete Position {{$item->name_position}}?</p>
                               </div>
                               <div class="p-2">
