                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body px-0">
                         <h5 class="card-title float-left mb-2 tx">Employee Type List</h5>
                         <div class="float-right"> 
                          <form method="get">    
                            <div class="form-group mb-3" style="display: flex"> 
                              <a href="{{url('admin/manage-employee-type/add')}}">
                                <div class="btn btn-success mr-2" style="width: 140px;">Add employee type</div>      
                              </a>                
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-striped">
                            <thead>
                              <th width="3%">#</th>
                              <th width="4%">Code</th>
                              <th width="15%">Name Employee Type</th>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                 <p>You Agree Delete Employee Type {{$item->name}}?</p>
                               </div>
                               <div class="p-2">
