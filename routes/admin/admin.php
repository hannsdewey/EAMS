...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'checkadmin'], function () {
        ...
        // Leave Type Routes (CRUD)
        Route::prefix('leave-types')->group(function () {
            Route::get('/', [LeaveTypeController::class, 'index'])->name('admin.leave-types.index');
            Route::get('/create', [LeaveTypeController::class, 'create'])->name('admin.leave-types.create');
            Route::post('/', [LeaveTypeController::class, 'store'])->name('admin.leave-types.store');

            // Use Model Binding (Laravel Automatically Resolves LeaveType)
            Route::get('/{leaveType}/edit', [LeaveTypeController::class, 'edit'])->name('admin.leave-types.edit');
            Route::put('/{leaveType}', [LeaveTypeController::class, 'update'])->name('admin.leave-types.update');
            Route::delete('/{leaveType}', [LeaveTypeController::class, 'destroy'])->name('admin.leave-types.destroy');
        });
